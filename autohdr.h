...
#line 1001 "classes.cpp"
  extern vector<modelinfo> mdinf;
#line 1054 "classes.cpp"
...
#line 457 "locations.cpp"
  bool proper(cell *c, int d);
#line 460 "locations.cpp"
...
#line 498 "locations.cpp"
  movei moveimon(cell *c);
#line 500 "locations.cpp"
...
#line 664 "hyperpoint.cpp"
  transmatrix zpush(ld z);
#line 666 "hyperpoint.cpp"
...
#line 1280 "hyperpoint.cpp"
  ld signum(ld x);
#line 1282 "hyperpoint.cpp"
  bool asign(ld y1, ld y2);
#line 1284 "hyperpoint.cpp"
...
#line 1401 "hyperpoint.cpp"
  hyperpoint ctangent(int c, ld x);
#line 1404 "hyperpoint.cpp"
...
#line 1190 "floorshapes.cpp"
  void ensure_vertex_number(basic_textureinfo& bti, int qty);
#line 1199 "floorshapes.cpp"
  void ensure_vertex_number(hpcshape& sh);
#line 1203 "floorshapes.cpp"
  void bind_floor_texture(hpcshape& li, int id);
#line 1209 "floorshapes.cpp"
  const int FLOORTEXTURESIZE = 4096;
#line 1297 "floorshapes.cpp"
...
#line 289 "pattern2.cpp"
  int i1414val(heptagon* h);
#line 295 "pattern2.cpp"
  int i1414val(cell *c);
#line 361 "pattern2.cpp"
  int zebra40(cell *c);
#line 422 "pattern2.cpp"
  int zebra3(cell *c);
  #if CAP_FIELD
  namespace fieldpattern {
#line 442 "pattern2.cpp"
    pair<int, bool> fieldval(cell *c);
#line 448 "pattern2.cpp"
    int fieldval_uniq(cell *c);
#line 490 "pattern2.cpp"
    int fieldval_uniq_rand(cell *c, int randval);
    }
  #endif
#line 531 "pattern2.cpp"
  int getHemisphere(heptagon *h, int which);
#line 560 "pattern2.cpp"
  int getHemisphere(cell *c, int which);
  namespace patterns {
#line 636 "pattern2.cpp"
    enum ePattern : char {
    PAT_NONE = 0,
    PAT_TYPES = 'T',
    PAT_ZEBRA = 'z',
...
#line 3013 "pattern2.cpp"
    void clearAll();
#line 3017 "pattern2.cpp"
    extern ld width;
#line 3019 "pattern2.cpp"
    void drawAll();
#line 3038 "pattern2.cpp"
    void showMenu();
    }
...
#line 2187 "complex.cpp"
    #define MELTCOLOR 0xA04040
#line 2220 "complex.cpp"
    void processfires();
    }
#line 2338 "complex.cpp"
  void livecaves();
  namespace tortoise {
#line 2508 "complex.cpp"
    extern map<cell*, int> emap;
#line 2509 "complex.cpp"
    extern map<cell*, int> babymap;
#line 2510 "complex.cpp"
    extern int last;
#line 2513 "complex.cpp"
    enum tflag {
...
#line 2714 "complex.cpp"
    int totalhp(cell *c);
#line 2766 "complex.cpp"
    bool move(const movei& mi);
    }
  namespace sword {
#line 2804 "complex.cpp"
    struct sworddir {
    int angle;
    transmatrix T;
    };
...
#line 2921 "complex.cpp"
    sworddir initial(cell *c);
#line 2935 "complex.cpp"
    void reset();
    }
  namespace kraken {
#line 2947 "complex.cpp"
    cell *head(cell *c);
#line 2953 "complex.cpp"
    void kill(cell *c, eMonster who);
#line 2975 "complex.cpp"
    int totalhp(cell *c);
#line 2991 "complex.cpp"
    void attacks();
...
#line 3377 "complex.cpp"
    extern eWall wlive;
#line 3379 "complex.cpp"
    extern set<cell*> changed;
#line 3381 "complex.cpp"
    void list_adj(cell *c);
#line 3389 "complex.cpp"
...
#line 3552 "complex.cpp"
    int getId(cell *c);
#line 3564 "complex.cpp"
    extern vector<unsigned char> windcodes;
#line 3580 "complex.cpp"
    void create();
#line 3668 "complex.cpp"
    int at(cell *c);
    }
  #endif
  namespace halloween {
#line 3678 "complex.cpp"
    extern cell *dragoncells[4];
#line 3756 "complex.cpp"
    void getTreat(cell *where);
#line 3762 "complex.cpp"
    void after_treat();
    }
  namespace dungeon {
#line 4232 "complex.cpp"
...
#line 745 "basegraph.cpp"
  bool displaystr(int x, int y, int shift, int size, const string &s, color_t color, int align);
#line 749 "basegraph.cpp"
  bool displayfrSP(int x, int y, int sh, int b, int size, const string &s, color_t color, int align, int p);
#line 766 "basegraph.cpp"
  bool displayfr(int x, int y, int b, int size, const string &s, color_t color, int align);
#line 770 "basegraph.cpp"
  bool displaychr(int x, int y, int shift, int size, char chr, color_t col);
  #endif
#line 779 "basegraph.cpp"
  struct msginfo {
  int stamp;
  time_t rtstamp;
  int gtstamp;
...
#line 850 "basegraph.cpp"
  int rhypot(int a, int b);
#line 852 "basegraph.cpp"
  ld realradius();
#line 866 "basegraph.cpp"
...
#line 1041 "basegraph.cpp"
  extern bool vsync_off;
#line 1043 "basegraph.cpp"
  void do_setfsize();
#line 1049 "basegraph.cpp"
  void disable_vsync();
  #if CAP_SDL
#line 1056 "basegraph.cpp"
  void setvideomode();
  #endif
#line 1139 "basegraph.cpp"
  extern bool noGUI;
#line 1141 "basegraph.cpp"
  void initgraph();
...
#line 147 "config.cpp"
  void addparamsaver(ld& val, const string s);
#line 152 "config.cpp"
  void addparamsaver(ld& val, const string p, const string s);
#line 157 "config.cpp"
...
#line 1277 "control.cpp"
  ...
  #endif
  namespace ors {
#line 1283 "control.cpp"
    extern int mode;
#line 1290 "control.cpp"
    extern string choices[3];
    #if CAP_ORIENTATION
#line 1293 "control.cpp"
    transmatrix getOrientation();
    #endif
#line 1298 "control.cpp"
    void reset();
#line 1311 "control.cpp"
    void show();
#line 1394 "control.cpp"
    void unrotate(transmatrix& T);
#line 1398 "control.cpp"
    void rerotate(transmatrix& T);
#line 1404 "control.cpp"
...
#line 186 "drawing.cpp"
  void glflush();
  #endif
  #if CAP_POLY
#line 257 "drawing.cpp"
  #define POLYMAX 60000
#line 260 "drawing.cpp"
...
#line 260 "environment.cpp"
  void bfs();
#line 521 "environment.cpp"
  void moverefresh(bool turn IS(true));
#line 743 "environment.cpp"
  void settemp(cell *c);
#line 748 "environment.cpp"
  void findWormIvy(cell *c);
#line 794 "environment.cpp"
  void monstersTurn();
...
#line 1351 "nonisotropic.cpp"
    int wall_offset(cell *c);
#line 1435 "nonisotropic.cpp"
    vector<pair<int, cell*>> gen_sample_list();
#line 1446 "nonisotropic.cpp"
    void will_link(cell *c);
#line 1448 "nonisotropic.cpp"
    extern bool in_link;
#line 1450 "nonisotropic.cpp"
    void link();
#line 1474 "nonisotropic.cpp"
    int celldistance(cell *c1, cell *c2);
#line 1501 "nonisotropic.cpp"
    void configure_period();
    }
  namespace product {
#line 1604 "nonisotropic.cpp"
    extern bool current_spin_invalid, cmirror;
#line 1605 "nonisotropic.cpp"
    extern int cspin;
#line 1608 "nonisotropic.cpp"
    hyperpoint inverse_exp(hyperpoint h);
#line 1630 "nonisotropic.cpp"
    hyperpoint direct_exp(hyperpoint h);
#line 1640 "nonisotropic.cpp"
    bool validate_spin();
#line 1662 "nonisotropic.cpp"
    void show_config();
    }
  namespace slr {
#line 1701 "nonisotropic.cpp"
    extern ld range_xy;
#line 1702 "nonisotropic.cpp"
    extern int steps;
#line 1704 "nonisotropic.cpp"
    transmatrix translate(hyperpoint h);
#line 1713 "nonisotropic.cpp"
    hyperpoint polar(ld r, ld theta, ld phi);
#line 1717 "nonisotropic.cpp"
    hyperpoint xyz_point(ld x, ld y, ld z);
#line 1723 "nonisotropic.cpp"
    hyperpoint get_inverse_exp(shiftpoint h);
#line 1900 "nonisotropic.cpp"
    extern string slshader;
    }
  namespace rots {
#line 2045 "nonisotropic.cpp"
    transmatrix uxpush(ld x);
#line 2050 "nonisotropic.cpp"
    transmatrix uypush(ld y);
#line 2055 "nonisotropic.cpp"
    transmatrix uzpush(ld z);
#line 2060 "nonisotropic.cpp"
    transmatrix lift_matrix(const transmatrix& T);
#line 2078 "nonisotropic.cpp"
    transmatrix ray_iadj(cell *c1, int i);
#line 2141 "nonisotropic.cpp"
    transmatrix qtm(hyperpoint h);
#line 2188 "nonisotropic.cpp"
    extern ld underlying_scale;
#line 2190 "nonisotropic.cpp"
    void draw_underlying(bool cornermode);
#line 2251 "nonisotropic.cpp"
    hyperpoint formula_exp(hyperpoint vel);
    }
  namespace stretch {
#line 2313 "nonisotropic.cpp"
    extern ld factor;
#line 2315 "nonisotropic.cpp"
    extern bool mstretch;
#line 2317 "nonisotropic.cpp"
    extern transmatrix m_itoa, m_atoi, m_pd;
#line 2318 "nonisotropic.cpp"
    extern ld ms_christoffel[3][3][3];
#line 2320 "nonisotropic.cpp"
    extern transmatrix mstretch_matrix;
#line 2322 "nonisotropic.cpp"
...
#line 1220 "patterns.cpp"
  int firsti1414val(int d);
#line 1225 "patterns.cpp"
  int nexti1414val(int par, int gpar, int d);
...
#line 78 "raycaster.cpp"
    bool available();
#line 108 "raycaster.cpp"
    bool requested();
#line 122 "raycaster.cpp"
...
#line 180 "raycaster.cpp"
    void reset_raycaster();
#line 216 "raycaster.cpp"
    extern hookset<void(string&, string&)> hooks_rayshader;
#line 217 "raycaster.cpp"
    extern hookset<bool(shared_ptr<raycaster>)> hooks_rayset;
#line 1305 "raycaster.cpp"
    void cast();
    namespace volumetric {
#line 1671 "raycaster.cpp"
      extern bool on;
#line 1673 "raycaster.cpp"
      extern map<cell*, color_t> vmap;
#line 1677 "raycaster.cpp"
      void enable();
#line 1684 "raycaster.cpp"
      void random_fog();
#line 1690 "raycaster.cpp"
      void menu();
      }
#line 1742 "raycaster.cpp"
    void configure();
    #endif
    #if !CAP_RAY
#line 1947 "raycaster.cpp"
    extern always_false in_use;
#line 1948 "raycaster.cpp"
    extern always_false comparison_mode;
#line 1949 "raycaster.cpp"
    void reset_raycaster();
#line 1950 "raycaster.cpp"
    void cast();
    #endif
    }
...
#line 1403 "screenshot.cpp"
    bool record_video_std();
    #endif
#line 1440 "screenshot.cpp"
    extern ld a, b;
#line 1461 "screenshot.cpp"
    void rug_angle_options();
#line 1474 "screenshot.cpp"
    void show();
#line 1795 "screenshot.cpp"
    bool any_animation();
#line 1803 "screenshot.cpp"
    bool any_on();
#line 1807 "screenshot.cpp"
    bool center_music();
    }
  #endif
