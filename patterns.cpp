...
#define RULE1414(a,b,c,d,e,f,g,h) {b,c,d,e,f,g,h}

int table1414[60][7] = {
  RULE1414(0, 4, 28, 24, 20, 16, 12, 8),
  RULE1414(1, 5, 9, 13, 17, 21, 25, 29),
  RULE1414(2, 6, 30, 26, 22, 18, 14, 10),
  RULE1414(3, 7, 11, 15, 19, 23, 27, 31),
  RULE1414(4, 48, 33, 35, 44, 28, 0, 8),
  RULE1414(5, 49, 9, 1, 29, 45, 32, 34),
  RULE1414(6, 50, 35, 33, 46, 30, 2, 10),
  RULE1414(7, 51, 11, 3, 31, 47, 34, 32),
  RULE1414(8, 52, 37, 39, 48, 4, 0, 12),
  RULE1414(9, 53, 13, 1, 5, 49, 36, 38),
  RULE1414(10, 54, 39, 37, 50, 6, 2, 14),
  RULE1414(11, 55, 15, 3, 7, 51, 38, 36),
  RULE1414(12, 56, 41, 43, 52, 8, 0, 16),
  RULE1414(13, 57, 17, 1, 9, 53, 40, 42),
  RULE1414(14, 58, 43, 41, 54, 10, 2, 18),
  RULE1414(15, 59, 19, 3, 11, 55, 42, 40),
  RULE1414(16, 32, 45, 47, 56, 12, 0, 20),
  RULE1414(17, 33, 21, 1, 13, 57, 44, 46),
  RULE1414(18, 34, 47, 45, 58, 14, 2, 22),
  RULE1414(19, 35, 23, 3, 15, 59, 46, 44),
  RULE1414(20, 36, 49, 51, 32, 16, 0, 24),
  RULE1414(21, 37, 25, 1, 17, 33, 48, 50),
  RULE1414(22, 38, 51, 49, 34, 18, 2, 26),
  RULE1414(23, 39, 27, 3, 19, 35, 50, 48),
  RULE1414(24, 40, 53, 55, 36, 20, 0, 28),
  RULE1414(25, 41, 29, 1, 21, 37, 52, 54),
  RULE1414(26, 42, 55, 53, 38, 22, 2, 30),
  RULE1414(27, 43, 31, 3, 23, 39, 54, 52),
  RULE1414(28, 44, 57, 59, 40, 24, 0, 4),
  RULE1414(29, 45, 5, 1, 25, 41, 56, 58),
  RULE1414(30, 46, 59, 57, 42, 26, 2, 6),
  RULE1414(31, 47, 7, 3, 27, 43, 58, 56),
  RULE1414(32, 16, 20, 51, 7, 34, 5, 45),
  RULE1414(33, 17, 46, 6, 35, 4, 48, 21),
  RULE1414(34, 18, 22, 49, 5, 32, 7, 47),
  RULE1414(35, 19, 44, 4, 33, 6, 50, 23),
  RULE1414(36, 20, 24, 55, 11, 38, 9, 49),
  RULE1414(37, 21, 50, 10, 39, 8, 52, 25),
  RULE1414(38, 22, 26, 53, 9, 36, 11, 51),
  RULE1414(39, 23, 48, 8, 37, 10, 54, 27),
  RULE1414(40, 24, 28, 59, 15, 42, 13, 53),
  RULE1414(41, 25, 54, 14, 43, 12, 56, 29),
  RULE1414(42, 26, 30, 57, 13, 40, 15, 55),
  RULE1414(43, 27, 52, 12, 41, 14, 58, 31),
  RULE1414(44, 28, 4, 35, 19, 46, 17, 57),
  RULE1414(45, 29, 58, 18, 47, 16, 32, 5),
  RULE1414(46, 30, 6, 33, 17, 44, 19, 59),
  RULE1414(47, 31, 56, 16, 45, 18, 34, 7),
  RULE1414(48, 4, 8, 39, 23, 50, 21, 33),
  RULE1414(49, 5, 34, 22, 51, 20, 36, 9),
  RULE1414(50, 6, 10, 37, 21, 48, 23, 35),
  RULE1414(51, 7, 32, 20, 49, 22, 38, 11),
  RULE1414(52, 8, 12, 43, 27, 54, 25, 37),
  RULE1414(53, 9, 38, 26, 55, 24, 40, 13),
  RULE1414(54, 10, 14, 41, 25, 52, 27, 39),
  RULE1414(55, 11, 36, 24, 53, 26, 42, 15),
  RULE1414(56, 12, 16, 47, 31, 58, 29, 41),
  RULE1414(57, 13, 42, 30, 59, 28, 44, 17),
  RULE1414(58, 14, 18, 45, 29, 56, 31, 43),
  RULE1414(59, 15, 40, 28, 57, 30, 46, 19),
  };

#undef RULE1414

EX int firsti1414val(int d) {
  if(S7 == 8 && d > 3) d--;
  return table1414[0][d];
  }

EX int nexti1414val(int par, int gpar, int d) {
  if(S7 == 8 && d > 3) d--;
  for(int i=0; i<7; i++) if(table1414[par][i] == gpar)
    return table1414[par][(i+d)%7];
  if(weirdhyperbolic && geometry != gRoomsQuotient) return 0;
  printf("14-14 pattern error!\n");
  exit(1);
  }
